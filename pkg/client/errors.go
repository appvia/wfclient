...
var (
	...
	ErrMissingProfile = errors.New("profile does not exist")
	// ErrNonExchangeToken indicates the token is not used to exchange
	ErrNonExchangeToken = errors.New("not a valid exchange token")
)
